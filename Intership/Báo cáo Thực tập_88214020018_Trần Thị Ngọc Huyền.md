...
Để bắt đầu công việc, em đã được các anh chị tại công ty cung cấp hệ thống nội quy, quy trình làm việc Agile và các tài liệu đào tạo nội bộ cần thiết. Mentor đã trực tiếp bàn giao cho em đề tài thực tập cùng những yêu cầu sơ bộ từ phía khách hàng về website Blog tài chính. Ngoài ra, đầu vào của em còn bao gồm các nguồn dữ liệu tin cậy về kinh tế học như tỷ lệ lạm phát, các công thức tính lãi suất kép và các báo cáo nghiên cứu về nhu cầu chi tiêu của người cao tuổi tại Việt Nam mà em đã chủ động khai thác từ các nguồn thông tin chính thống trên internet.
...
| --- | --- | --- |
| 1 | Hệ thống Blog | Hiển thị danh mục bài viết, tìm hiểu kiến thức tài chính, hưu trí và đầu tư. |
...
Mục tiêu cốt lõi của em trong phần này là kiến tạo nên bộ "khung xương" vững chắc cho toàn bộ dự án Kim Hương Finance. Em cần định hình rõ ràng cấu trúc các màn hình (Screen Flow) để tối ưu hóa trải nghiệm điều hướng, đồng thời chuẩn hóa các luồng nghiệp vụ phức tạp của bộ tính toán hưu trí. Thông qua việc mô hình hóa bằng sơ đồ, em có thể đảm bảo mọi tương tác của người dùng, từ đọc blog đến nhập liệu tài chính, đều diễn ra một cách logic và mượt mà nhất.
...
```mermaid
graph TD
    Home[Trang chủ] --> Blog[Danh mục Blog]
    Home --> About[Giới thiệu - Về tôi]
    Home --> Calculator[Công cụ Hưu trí 7 bước]
    Home --> Auth[Đăng ký / Đăng nhập]
    
    Blog --> Post[Chi tiết bài viết tài chính]
...
graph LR
    ...
    subgraph "Hệ thống Kim Hương Finance"
        UC1(Xem bài viết & Giới thiệu)
        UC2(Lập kế hoạch hưu trí)
        UC3(Đăng ký/Đăng nhập)
        UC4(Lưu kết quả & Xem lại kế hoạch)
        UC5(Quản lý danh sách khách hàng)
        UC6(Theo dõi lịch sử kết quả nhập của User)
    end
