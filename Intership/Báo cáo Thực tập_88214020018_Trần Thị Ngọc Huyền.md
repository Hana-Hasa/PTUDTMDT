...
| **TRƯỜNG KINH TẾ**                                                                |                                                                        |
+:=================================================================================:+:======================================================================:+
| ![](media/image2.png){width="2.1093744531933507in" height="1.3975688976377953in"} | ![](media/image3.png){width="1.21875in" height="1.21875in"}            |
+-----------------------------------------------------------------------------------+------------------------------------------------------------------------+
...
Sau 10 tuần thực tập tại Công ty Cổ phần Dịch vụ Công nghệ LHD, em đã đạt được các kết quả cụ thể như sau:

**Về sản phẩm:**

- Hoàn thiện bộ tài liệu đặc tả sản phẩm (PRD) cho website Kim Hương Finance và sơ đồ luồng (Flow Diagram) chi tiết cho công cụ hoạch định 7 bước.
- Xây dựng thành công website với cấu trúc 3 trang (Home, About Me, Retirement Plan) chuyên nghiệp và hiện đại.
- Thiết kế bộ UI/UX hoàn chỉnh trên Figma, đảm bảo tính Responsive và thân thiện với người dùng.
- Công cụ tính toán hưu trí hoạt động chính xác, đã qua kiểm thử (UAT) đối soát với dữ liệu thực tế.
- Website đã được triển khai lên Vercel, chạy ổn định và đạt hiệu năng cao trên cả thiết bị máy tính và điện thoại di động.

**Về kiến thức và kỹ năng:**

- Hiểu sâu về quy trình BA trong thực tế: Từ thu thập yêu cầu, viết PRD đến vẽ Flow và kiểm thử sản phẩm.
- Áp dụng thành công các công thức tài chính (lạm phát, lãi suất kép) vào logic phần mềm.
- Thành thạo công cụ phân tích và thiết kế: Figma (Thiết kế UI/UX), Next.js (Frontend framework), PRD & Flow Diagram (Tài liệu nghiệp vụ).
- Rèn luyện kỹ năng giao tiếp chuyên nghiệp, trình bày báo cáo và làm việc nhóm trong môi trường Agile.

## 4.2 Bài học kinh nghiệm

Qua thời gian thực tập, em đã rút ra được những bài học quý giá về cả chuyên môn lẫn kỹ năng mềm:

**Về chuyên môn:**

- **Tầm quan trọng của Domain Knowledge**: Đối với dự án Kim Hương Finance, việc hiểu đúng về tài chính cá nhân, lãi suất và các quy tắc hoạch định hưu trí là yếu tố tiên quyết. Em nhận ra rằng BA giỏi cần có khả năng nghiên cứu sâu các lĩnh vực chuyên môn để đưa ra giải pháp chính xác.
- **Tính chính xác của logic tính toán**: Trong Fintech, một sai sót nhỏ trong công thức cũng dẫn đến kết quả sai lệch lớn. Em học được cách kiểm thử kỹ lưỡng các kịch bản tài chính khác nhau dựa trên PRD và Flow.
- **Bảo mật và trải nghiệm người dùng**: Việc bảo mật thông tin tài chính và một quy trình nhập liệu đơn giản, tinh tế giúp kích thích người dùng hoàn thành kế hoạch hưu trí.

**Về kỹ năng mềm:**

- **Giao tiếp chủ động**: Không ngại hỏi khi chưa hiểu và luôn cập nhật tiến độ với Mentor giúp công việc diễn ra trơn tru hơn.
- **Quản lý thời gian**: Biết ưu tiên đầu việc quan trọng và phân chia thời gian hợp lý giúp em đảm bảo tiến độ dù khối lượng công việc khá lớn.
- **Tư duy sản phẩm (Product Mindset)**: Luôn đặt câu hỏi "Người dùng thực sự cần gì?" thay vì chỉ làm theo yêu cầu kỹ thuật.
...
Em tin rằng những kiến thức, kỹ năng và kinh nghiệm tích lũy qua kỳ thực tập này sẽ là hành trang vững chắc cho em trên con đường phát triển sự nghiệp trong tương lai.
